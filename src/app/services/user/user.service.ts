...
export class UserService {
  ...
  loginWithToken(): Observable<User> {
    ...
    this.http
      .get<User>(this.api + "login-with-token", options)
      .subscribe((data) => {
        this.user.next(data);
      });
  ...
  saveUser(user: User) {
    ...
    this.http
      .put<User>(this.api + "", JSON.stringify(user), options)
      .subscribe((data) => {
        this.user.next(data);
      });
  ...
  getUsers(): Observable<User[]> {
    ...
    this.http.get<User[]>(this.api, options).subscribe((data) => {
  ...
  deleteUser(id: number): Observable<User> {
    ...
    this.http.delete<User>(this.api + id, options).subscribe((data) => {
      this.getUsers();
    });
  ...
  makeAdmin(id: number): Observable<User> {
    ...
    this.http
      .get<User>(this.api + "make-user-an-admin/" + id, options)
      .subscribe((data) => {
        this.getUsers();
      });
